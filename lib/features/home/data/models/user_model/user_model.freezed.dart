...
class _$_UserModel implements _UserModel {
  _$_UserModel(
      ...
      required this.email,
      required this.token,
      @JsonKey(name: 'token_expiry') required this.tokenExpiry});
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, countryCode, phone, email, token, tokenExpiry);
...
abstract class _UserModel implements UserModel {
  factory _UserModel(
          ...
          @JsonKey(name: 'token_expiry') required final String tokenExpiry}) =
      _$_UserModel;
