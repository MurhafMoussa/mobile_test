...
class _$_ApiErrorResponse implements _ApiErrorResponse {
  _$_ApiErrorResponse({this.message});

  factory _$_ApiErrorResponse.fromJson(Map<String, dynamic> json) =>
      _$$_ApiErrorResponseFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$_ApiErrorResponseToJson(
      this,
    );
  }
}
...
abstract class _ApiErrorResponse implements ApiErrorResponse {
  factory _ApiErrorResponse({final String? message}) = _$_ApiErrorResponse;

  factory _ApiErrorResponse.fromJson(Map<String, dynamic> json) =
      _$_ApiErrorResponse.fromJson;
